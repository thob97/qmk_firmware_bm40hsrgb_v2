...
MAGIC_TOGGLE_CTL_GUI, RMIS, RMDS, RMIV, RMDV, KC_NO, KC_NO, KC_F4, KC_F5, KC_F6, KC_F11, RSG(KC_5),
KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_F12, KC_RSFT,
MAGIC_SWAP_CTL_GUI, KC_NO, KC_NO, KC_TRNS, KC_NO, TD(MySafeReset), RSG(KC_GRV), RCTL(KC_4),  RCS(KC_4),  RGUI(KC_GRV), KC_RGUI),
